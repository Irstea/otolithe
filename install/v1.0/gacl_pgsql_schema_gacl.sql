...
insert into logingestion (id, login, password, nom) values
(1,	'admin',	'5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8',	'Administrateur'),
(5,	'gestion',	'5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8',	'Gestionnaire');
--
...
GRANT ALL ON SCHEMA gacl TO thalassotoque_gacl_g;
...
REVOKE ALL ON TABLE logingestion FROM thalassotoque_gacl_g;
GRANT ALL ON TABLE logingestion TO thalassotoque_gacl_g;
...
REVOKE ALL ON SEQUENCE seq_logingestion_id FROM thalassotoque_gacl_g;
GRANT ALL ON SEQUENCE seq_logingestion_id TO thalassotoque_gacl_g;
